...
} & Pick<Contract, "startDate" | "endDate" | "parkIds" | "type">;
/**
 * 合同列表
 */
 ...
 * 押金应收弹窗
 */
export type IDepositAndReceive = Record<
  "depositDetailList" | "generateReceiveContractDetails",
  IContractDetails[]
>;
/**
 * 合同客户变更
 ...
 * 合同变更基础详情
 */
export type IContractChange = {
  oldBillCycle?: number;
  newBillCycle?: number;
  newBillCylceStart?: string;
} & Pick<
  Contract,
  | "id"
  | "contractCode"
  ...
  | "verifyTime"
>;
export type IModifyDetailList = IContractDetails &
  Pick<Contract, "changeDetailId" | "newEndTime">;
/**
 * 合同变更详情
 */
