    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          { label: '呼玛县', value: '呼玛县' },
          { label: '塔河县', value: '塔河县' },
          { label: '大兴安岭地区加格达奇区', value: '大兴安岭地区加格达奇区' },
          { label: '大兴安岭地区呼中区', value: '大兴安岭地区呼中区' },
          { label: '大兴安岭地区新林区', value: '大兴安岭地区新林区' },
          { label: '大兴安岭地区松岭区', value: '大兴安岭地区松岭区' },
          { label: '漠河县', value: '漠河县' },
          { label: '其他', value: '其他' }
        ]
      }
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          { label: '请选择', value: '' },
          { label: '乌兰县', value: '乌兰县' },
          { label: '冷湖行委', value: '冷湖行委' },
          { label: '大柴旦行委', value: '大柴旦行委' },
          { label: '天峻县', value: '天峻县' },
          { label: '德令哈市', value: '德令哈市' },
          { label: '格尔木市', value: '格尔木市' },
          { label: '茫崖行委', value: '茫崖行委' },
          { label: '都兰县', value: '都兰县' },
          { label: '其他', value: '其他' }
        ]
      }
