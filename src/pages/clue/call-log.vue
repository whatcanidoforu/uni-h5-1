    ...
    <view class="page-content">
      ...
      >
        ...
        >
          ...
          <view class="formatDuration line">
            <span>通话时长</span>
            <span>{{ item.formatDuration }}</span>
          </view>
          <view class="seatName line">
            <span>座席号</span>
            {{ item.seatName }}
          </view>
...
import { apiChanceGetChancePhoneRecord } from "@/http/api/clue";
...
const queryList = async (pageNo: number, pageSize: number) => {
  let res = await apiChanceGetChancePhoneRecord({
    id: Number(pageOption.value.chanceId),
  });
  if (!res) {
